...
export APP_IDENTITY="Apple Distribution"
export INSTALLER_IDENTITY="3rd Party Mac Developer Installer"

# Build the MAS-compliant package
# This script handles staging, Info.plist metadata injection, and signing.
printf "\n📦 Building MAS Package for TestFlight...\n"
./create-mas-pkg.sh "$ARTIFACTS_DIR" "$OUTPUT_PKG" "1.0.0"
